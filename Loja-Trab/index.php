<?php
    ...
    require_once __DIR__. "/app/models/CrudProdutos.php";
...
<head>
    ...
    <title>Gaymer Kawaii Desu</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php"><img src="assets/imagens/kuru.png" alt="" width="120px"></a>
...
<header class="jumbotron my-4 home-banner">
    <div class="container">
        <h1 class="display-3">Gaymer Kawaii Desu</h1>
        <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa, ipsam, eligendi, in quo sunt possimus non incidunt odit vero aliquid similique quaerat nam nobis illo aspernatur vitae fugiat numquam repellat.</p>
        <a href="app/views/admin/produtos.php" class="btn btn-primary btn-lg">Venha conferir!</a>
    </div>
</header>
